...
function getRiskBand(score) {
    if (score >= 0.85) return { label: 'CRITICAL', colour: '#7F1D1D' };
    if (score >= 0.7) return { label: 'HIGH', colour: '#DC2626' };
    if (score >= 0.4) return { label: 'MODERATE', colour: '#D97706' };
    return { label: 'LOW', colour: '#059669' };
}
